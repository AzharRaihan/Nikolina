    ...
    <section class="game-page">
        <div class="container">
                ...
                <div class="row ">
                    <div class="col-12 col-md-6 col-lg-6 col-xl-6 pt-5">
                        <div class="games-icon text-center">
                            <img src="assets/img/games-categories/cats-trophy.png" alt="games3" class="img-fluid">
                        </div>
                        <a href="#">
                    ...
                    <div class="col-12 col-md-6 col-lg-6 col-xl-6 pt-5">
                        <div class="games-icon text-center">
                            <img src="assets/img/games-categories/jolly-jam.png" alt="games3" class="img-fluid">
                        </div>
                        <a href="#">
                            <div class="games-body">
            ...
            <ul class="pagination justify-content-end pb-3">
                <li class="page-item"><a class="page-link" href="games2.php">Previous</a></li>
