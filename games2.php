...
<body>
    ...
    <img src="assets/img/other-page-banner/game.jpg" alt="public-speaking" class="img-fluid">
    <!-- Speaking Banner Section End -->

    <!-- Games Categories -->
    <section class="game-page">
        <div class="container">
            <div class="games-heading text-center d-flex justify-content-center align-items-center">
                <h1 style="color: #FF119B;">Games</h1>
            </div>
                ...
                <div class="row ">
                    <div class="col-12 col-md-6 col-lg-6 col-xl-6 pt-5">
                        <div class="games-icon text-center">
                            <img src="assets/img/games-categories/tiny-thief.png" alt="games3" class="img-fluid">
                        </div>
                        <a href="#">
                    ...
                    <div class="col-12 col-md-6 col-lg-6 col-xl-6 pt-5">
                        <div class="games-icon text-center">
                            <img src="assets/img/games-categories/topgear.png" alt="games3" class="img-fluid">
                        </div>
                        <a href="#">
                            <div class="games-body">
                    ...
                    <div class="col-12 col-md-6 col-lg-6 col-xl-6 pt-5">
                        <div class="games-icon text-center">
                            <img src="assets/img/games-categories/wordmonsters.png" alt="games3" class="img-fluid">
                        </div>
                        <a href="#">
                            <div class="games-body">
                    ...
                    <div class="col-12 col-md-6 col-lg-6 col-xl-6 pt-5">
                        <div class="games-icon text-center">
                            <img src="assets/img/games-categories/solid-soccer.png" alt="games3" class="img-fluid">
                        </div>
                        <a href="#">
                            <div class="games-body">
                    ...
                    <div class="col-12 col-md-6 col-lg-6 col-xl-6 pt-5">
                        <div class="games-icon text-center">
                            <img src="assets/img/games-categories/angry-birds-epic.png" alt="games3" class="img-fluid">
                        </div>
                        <a href="#">
                            <div class="games-body">
                    ...
                    <div class="col-12 col-md-6 col-lg-6 col-xl-6 pt-5">
                        <div class="games-icon text-center">
                            <img src="assets/img/games-categories/angry-birds-friends.png" alt="games3" class="img-fluid">
                        </div>
                        <a href="#">
                            <div class="games-body">
            ...
            <ul class="pagination justify-content-end pb-3">
                <li class="page-item"><a class="page-link" href="games.php">Previous</a></li>
                <li class="page-item"><a class="page-link" href="games.php">1</a></li>
                <li class="page-item"><a class="page-link" href="games2.php">2</a></li>
                <li class="page-item"><a class="page-link" href="games3.php">3</a></li>
                <li class="page-item"><a class="page-link" href="games3.php">Next</a></li>
            </ul>
        </div>
    </section>
