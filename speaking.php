...
<body>
    ...
    <section class="speaking">
        <div class="speaking-banner">
            <img src="assets/img/other-page-banner/speaking.jpg" alt="public-speaking" class="img-fluid">
        </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="notable-speaking">
                        <div class="notable-img-sec">
                            <img src="assets/img/speaking/notable-talk-s.png" alt="" class="img-fluid">
                        </div>
            ...
            <div class="row">
                <div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-4 mobile-pb-20">
                    <div class="speaking-card">
                        <img src="assets/img/speaking/sp-2.png" alt="" class="img-fluid">
                        <div class="caption">
                ...
                <div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-4 mobile-pb-20">
                    <div class="speaking-card">
                        <img src="assets/img/speaking/sp-3.png" alt="" class="img-fluid">
                        <div class="caption">
                ...
                <div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-4 mobile-pb-20">
                    <div class="speaking-card">
                        <img src="assets/img/speaking/sp-4.png" class="img-fluid">
                        <div class="caption">
    ...
    <!-- <section class="speaker-presentation-wrap my-sm-3 my-md-4 my-lg-5">
        <div class="speaker-presentation-img">
            <img src="assets/img/speaking/speaking3.png" alt="" class="img-fluid">
        </div>
